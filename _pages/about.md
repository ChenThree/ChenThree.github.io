...
- 2024.06.07: Our paper "Grasp as Points: A Novel Grasp Representation Guided RL Policy for Dynamic Object Grasping" has been submitted to ***IEEE Robotics and Automation Letters***.
- 2024.06.07: Our paper "Category-Agnostic Pose Estimation for Point Clouds" has been accepted to ***IEEE International Conference on Image Processing 2024***.
- 2024.06.06: Our paper "Region-aware Grasp Framework with Normalized Grasp Space for 6-DoF Grasping in Cluttered Scene" is released in ***arXiv preprint***. [[Link]](https://arxiv.org/pdf/2406.01767)
- 2024.06.03: Our paper "Region-Centric 6-Dof Grasp Detection: A Data-Efficient Solution for Cluttered Scenes" is under revision to ***IEEE Robotics and Automation Letters***.
...
- **Chen, S.**, Xie, P., Tang, W., Hu, D., & Wang, G. (2024). Region-aware Grasp Framework with Normalized Grasp Space for 6-DoF Grasping in Cluttered Scene. ***arXiv preprint***. [[Link]](https://arxiv.org/pdf/2406.01767)
